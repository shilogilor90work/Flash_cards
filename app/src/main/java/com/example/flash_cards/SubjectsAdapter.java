...
public class SubjectsAdapter extends ArrayAdapter {
    ...
    public SubjectsAdapter(Context context, ArrayList<String> records) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.subjects_listview, null);
        }
        ...
        btn_definitions.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getContext(),Definitions.class);
